...
protected: 
  ...
  char generalFault, tempFault, o2Fault;
  virtual void Init() = 0;
...
public:
  ...
  void setGeneralFault(char value) {generalFault = value;}
  void setTempFault(char value) {tempFault = value;}
  void setO2Fault(char value) {o2Fault = value;}  
};
