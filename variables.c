...
const T_DICT_VAR_DESCR dict_var_descrs[MAX_RECORD] = {
  ...
  {BASE_T_L + SHIFT_T,  INT,   INTERNAL,   0,  0,   "Shift_T",  "б/р",         55.0,  0.0, 10000.0, 3, TRUE},
  ...
  {BASE_T_L + T_DF_T,   FLOAT, INTERNAL,   6,  12,  "T_df_T",   "с",            1.0,  0.0, 10000.0, 3, TRUE},
  ...
  {BASE_T_R + T_DF_T,   FLOAT, INTERNAL,  26,  62,  "T_df_T",   "с",             1.0, 0.0, 10000.0, 3, TRUE},
  ...
  {BASE_O2_L + SHIFT_E, INT,   INTERNAL,  40,  200,  "Shift_K",  "-",         0.0,     0.0, 10000.0, 0, TRUE},  //Переменные настройки канала кислорода
  {BASE_O2_L + K_CD_E,  FLOAT, INTERNAL,  41,  202,  "K_cd_E",   "мкВ",       3.46,    0.0, 10000.0, 3, TRUE},
  ...
  {BASE_O2_L + X1,      FLOAT, INTERNAL,  46,  212,  "X1",       "об.%",      6.0,     0.0, 100.0,   3, TRUE},
  {BASE_O2_L + Y1,      FLOAT, INTERNAL,  47,  214,  "Y1",       "об.%",      6.0,     0.0, 100.0,   3, TRUE},
  {BASE_O2_L + X2,      FLOAT, INTERNAL,  48,  216,  "X2",       "об.%",      10.0,    0.0, 100.0,   3, TRUE},
  {BASE_O2_L + Y2,      FLOAT, INTERNAL,  49,  218,  "Y2",       "об.%",      8.0,     0.0, 100.0,   3, TRUE},
  {BASE_O2_L + X3,      FLOAT, INTERNAL,  50,  220, "X3",       "об.%",      14.0,    0.0, 100.0,   3, TRUE},
  {BASE_O2_L + Y3,      FLOAT, INTERNAL,  51,  222, "Y3",       "об.%",      6.0,     0.0, 100.0,   3, TRUE},
  {BASE_O2_L + X4,      FLOAT, INTERNAL,  52,  224, "X4",       "об.%",      17.0,    0.0, 100.0,   3, TRUE},
  {BASE_O2_L + Y4,      FLOAT, INTERNAL,  53,  226, "Y4",       "об.%",      6.0,     0.0, 100.0,   3, TRUE},
  {BASE_O2_L + X5,      FLOAT, INTERNAL,  54,  228, "X5",       "об.%",      20.0,    0.0, 100.0,   3, TRUE},
  {BASE_O2_L + Y5,      FLOAT, INTERNAL,  55,  230, "Y5",       "об.%",      12.0,    0.0, 100.0,   3, TRUE},
  {BASE_O2_L + K_I_O,   FLOAT, INTERNAL,  56,  232, "K_i_0",    "1/об%",     200.0,   0.0, 10000.0, 3, TRUE},
  ...
  {BASE_O2_R + K_CD_E,  FLOAT, INTERNAL,  71,  240,  "K_cd_E",   "мкВ",      3.46,    0.0, 10000.0, 3, TRUE},
  ...
  {BASE_O2_R + X1,      FLOAT, INTERNAL,  76,  252,  "X1",       "об.%",     6.0,     0.0, 100.0,   3, TRUE},
  {BASE_O2_R + Y1,      FLOAT, INTERNAL,  77,  254,  "Y1",       "об.%",     6.0,     0.0, 100.0,   3, TRUE},
  {BASE_O2_R + X2,      FLOAT, INTERNAL,  78,  256,  "X2",       "об.%",     10.0,    0.0, 100.0,   3, TRUE},
  {BASE_O2_R + Y2,      FLOAT, INTERNAL,  79,  258,  "Y2",       "об.%",     8.0,     0.0, 100.0,   3, TRUE},
  {BASE_O2_R + X3,      FLOAT, INTERNAL,  80,  260,  "X3",       "об.%",     14.0,    0.0, 100.0,   3, TRUE},
  {BASE_O2_R + Y3,      FLOAT, INTERNAL,  81,  262,  "Y3",       "об.%",     6.0,     0.0, 100.0,   3, TRUE},
  {BASE_O2_R + X4,      FLOAT, INTERNAL,  82,  264,  "X4",       "об.%",     17.0,    0.0, 100.0,   3, TRUE},
  {BASE_O2_R + Y4,      FLOAT, INTERNAL,  83,  266,  "Y4",       "об.%",     6.0,     0.0, 100.0,   3, TRUE},
  {BASE_O2_R + X5,      FLOAT, INTERNAL,  84,  268,  "X5",       "об.%",     20.0,    0.0, 100.0,   3, TRUE},
  {BASE_O2_R + Y5,      FLOAT, INTERNAL,  85,  270,  "Y5",       "об.%",     12.0,    0.0, 100.0,   3, TRUE},
  {BASE_O2_R + K_I_O,   FLOAT, INTERNAL,  86,  272,  "K_i_0",    "1/об%",   200.0,    0.0, 10000.0, 3, TRUE},
  ...
  {BASE_HN_L + T_F_H,   FLOAT, INTERNAL, 110,  300, "T_f_h",    "с",        1.0,     0.0, 10000.0, 3, TRUE},  //Переменные настройки канала химнедожога
  {BASE_HN_L + T_FF_H,  FLOAT, INTERNAL, 111,  302, "T_ff_h",   "с",        1.0,     0.0, 10000.0, 3, TRUE},
  ...
  {BASE_HN_L + LIM_H,   FLOAT, INTERNAL, 115,  310, "Lim_h",    "мВ",       50.0,    0.0, 5.0,     3, TRUE},
  {BASE_HN_L + KLIM_H,  FLOAT, INTERNAL, 116,  312, "KLim_h",   "%",       1.0,     0.0, 100.0,   3, TRUE},
  {BASE_HN_L + T_FD_H,  FLOAT, INTERNAL, 117,  314, "T_fd_h",   "с",        30.0,    0.0, 100.0,   3, TRUE},
  ...
  {BASE_HN_R + T_F_H,   FLOAT, INTERNAL, 150,  370, "T_f_h",    "с",        1.0,     0.0, 10000.0, 3, TRUE},
  {BASE_HN_R + T_FF_H,  FLOAT, INTERNAL, 151,  372, "T_ff_h",   "с",        1.0,     0.0, 10000.0, 3, TRUE},
  ...
  {BASE_HN_R + LIM_H,   FLOAT, INTERNAL, 155,  380, "Lim_h",    "мВ",       50.0,    0.0, 5.0,     3, TRUE},
  {BASE_HN_R + KLIM_H,  FLOAT, INTERNAL, 156,  382, "KLim_h",   "%",        1.0,     0.0, 100.0,   3, TRUE},
  {BASE_HN_R + T_FD_H,  FLOAT, INTERNAL, 157,  384, "T_fd_h",   "с",        30.0,    0.0, 100.0,   3, TRUE},
  ...
  {AN_OUT_1,            FLOAT, OUT,       -1,   -1, "Dac1",    "мА",       0.0,     0.0, 10000.0, 2, FALSE},
  {AN_OUT_2,            FLOAT, OUT,       -1,   -1, "Dac2",    "мА",       0.0,     0.0, 10000.0, 2, FALSE},
  {AN_OUT_3,            FLOAT, OUT,       -1,   -1, "Dac3",    "мА",       0.0,     0.0, 10000.0, 2, FALSE},
  {AN_OUT_4,            FLOAT, OUT,       -1,   -1, "Dac4",    "мА",       0.0,     0.0, 10000.0, 2, FALSE},
  {DAC_1,               INT,   OUT,       -1,   -1, "код DAC1",    "",       0.0,     0.0, 10000.0, 2, FALSE},
  {DAC_2,               INT,   OUT,       -1,   -1, "код DAC2",    "",       0.0,     0.0, 10000.0, 2, FALSE},
  {DAC_3,               INT,   OUT,       -1,   -1, "код DAC3",    "",       0.0,     0.0, 10000.0, 2, FALSE},
  {DAC_4,               INT,   OUT,       -1,   -1, "код DAC4",    "",       0.0,     0.0, 10000.0, 2, FALSE},   
  {PWM_1,               INT,   OUT,       -1,   -1, "PWM_1",    "",       0.0,     0.0, 10000.0, 2, FALSE},
  {PWM_2,               INT,   OUT,       -1,   -1, "PWM_2",    "",       0.0,     0.0, 10000.0, 2, FALSE},
  {HEATER_STATE_L,      BOOLEAN, IN,      -1,  484, "Обрыв Л.",  "",        0.0,     0.0, 1.0, 0, FALSE},  //обрыв цепи нагревателей
  {HEATER_STATE_R,      BOOLEAN, IN,      -1,  486, "Обрыв П.",  "",        0.0,     0.0, 1.0, 0, FALSE},
  {HEATER_OVERLOAD_L,   BOOLEAN, IN,      -1,  488, "Перегр.Л.",  "",        0.0,     0.0, 1.0, 0, FALSE},
  {HEATER_OVERLOAD_R,   BOOLEAN, IN,      -1,  490, "Перегр.П.",  "",        0.0,     0.0, 1.0, 0, FALSE},
  ...
  {SCR_BACKLIGHT_TIME,  INT,     INTERNAL, 231,  -1, "откл.подсв", "мин", 0.0, 0.0, 0.0, 0, TRUE},
  {PROTECT_RESET_TIME,  INT,     INTERNAL, 232,  -1, "сбр.защит", "с", 0.0, 0.0, 0.0, 0, TRUE},
  {PASS_RESET_TIME,     INT,     INTERNAL, 233,  -1, "сбр.пароля", "мин", 0.0, 0.0, 0.0, 0, TRUE},
