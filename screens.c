...
const T_SCREEN_DESCRIPTOR screens[] = {                                    
  ...
  {CLAPP_SCREEN, .scr.clapp_screen = {"КЛАПП ХН л. (3/4)",
  HN_X0_L, HN_Y0_L,
  HN_X1_L, HN_Y1_L,
  HN_X2_L, HN_Y2_L,
  HN_X3_L, HN_Y3_L,
  ...
  {CLAPP_SCREEN, .scr.clapp_screen = {"КЛАПП ХН п. (3/4)",
  HN_X0_R, HN_Y0_R,
  HN_X1_R, HN_Y1_R,
  HN_X2_R, HN_Y2_R,
  HN_X3_R, HN_Y3_R,
